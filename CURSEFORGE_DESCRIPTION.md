<p align="center">
  <img src="https://raw.githubusercontent.com/K2-Studio-Development/Terminus-Russian/main/assets/pack.png" width="160" alt="Terminus Russian Localization">
</p>
...
3. Put the localization file into the correct Minecraft folder.
4. Select Russian in the game language settings.

If you use the resource pack version, put the ZIP file into `resourcepacks` and enable it above other packs that may modify Terminus.

If you use the JAR version, install it like a normal mod and avoid mixing it with another Terminus translation to prevent resource conflicts.
...
3. Поместите файл локализации в нужную папку Minecraft.
4. Включите русский язык в настройках игры.

Если используете вариант в виде ресурспака, поместите ZIP в папку `resourcepacks` и включите его выше других пакетов, которые могут менять Terminus.

Если используете вариант в виде готового JAR, устанавливайте его как обычный мод и не смешивайте с другим переводом Terminus, чтобы не получить конфликт ресурсов.
